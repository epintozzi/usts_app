  ...
  describe "validations" do
    ...
    context "valid attributes" do
      it "is valid with all attributes" do
        race = Race.new(street_address: "123 Lake St", city: "DePue", state: "IL", start_date: "2017-07-26 16:33:57", end_date: "2017-07-30 16:33:57", sanction: "sanction.pdf", details: "details go here", fee_override: 50, latitude: 89.1234, longitude: 40.1234)
